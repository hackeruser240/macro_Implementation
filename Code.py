...
import logging
'''
This code simply implements the script using argparse.

'''
parser=ag.ArgumentParser()
parser.add_argument("--path",required=True, help="Enter the path you require to process")
